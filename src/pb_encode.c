...
{
    PRINTF("file: pb_encode.c - Line #221\n");
    pb_type_t type = field->type;

    PRINTF("file: pb_encode.c - Line #224\n");

    const void *pSize = (const char*)pData + field->size_offset;

    PRINTF("file: pb_encode.c - Line #225\n");
    ...
    PRINTF("file: pb_encode.c - Line #246\n");
        ...
        else if (PB_LTYPE(type) == PB_LTYPE_SUBMESSAGE)
        {
            ...
            if (pb_field_iter_begin(&iter, (const pb_field_t*)field->ptr, pb_const_cast(pData)))
            {
                ...
                do
                {
                    ...
                    PRINTF("file: pb_encode.c - Line #282\n");
    ...
    PRINTF("file: pb_encode.c - Line #293\n");
    ...
    const pb_field_t *field, const void *pData)
{
    ...
    {
        PRINTF("file: pb_encode.c - Line #322\n");
        /* Static optional, repeated or oneof field */
        pSize = (const char*)pData + field->size_offset;
    }
    else if (PB_HTYPE(field->type) == PB_HTYPE_OPTIONAL)
    {
        PRINTF("file: pb_encode.c - Line #328\n");
    ...
    PRINTF("file: pb_encode.c - Line #337\n");
    ...
    switch (PB_HTYPE(field->type))
    {
        ...
        PRINTF("file: pb_encode.c - Line #349\n");
            if (!pData)
        ...
        PRINTF("file: pb_encode.c - Line #359\n");
            if (*(const bool*)pSize)
            {
                if (!pb_encode_tag_for_field(stream, field))
                    return false;
        ...
        PRINTF("file: pb_encode.c - Line #370\n");
            if (!encode_array(stream, field, pData, *(const pb_size_t*)pSize, func))
                return false;
            break;
        
        case PB_HTYPE_ONEOF:
        PRINTF("file: pb_encode.c - Line #376\n");
        ...
        default:
        PRINTF("file: pb_encode.c - Line #388\n");
            PB_RETURN_ERROR(stream, "invalid field type");
    }
    PRINTF("file: pb_encode.c - Line #394\n");
    return true;
}
    ...
    const pb_field_t *field, const void *pData)
{
    switch (PB_ATYPE(field->type))
    {
        ...
        PRINTF("file: pb_encode.c - Line #419\n");
            return encode_basic_field(stream, field, pData);
        
        case PB_ATYPE_CALLBACK:
        PRINTF("file: pb_encode.c - Line #423\n");
...
bool checkreturn pb_encode(pb_ostream_t *stream, const pb_field_t fields[], const void *src_struct)
{
    ...
    PRINTF("file: pb_encode.c - Line #496\n");
    do {
        if (PB_LTYPE(iter.pos->type) == PB_LTYPE_EXTENSION)
        {
            PRINTF("file: pb_encode.c - Line #500\n");
        ...
        {
            PRINTF("file: pb_encode.c - Line #507\n");
            /* Regular field */
            if (!encode_field(stream, iter.pos, iter.pData))
                return false;
        }
        PRINTF("file: pb_encode.c - Line #512\n");
    } while (pb_field_iter_next(&iter));
